...
/**
 * Note that
 * maxReach is the maximum sum that can be formed using the elements in the
 * array
 * expected is the next number that needs to be formed
 * Both are long to avoid overflow
 */
